...
def reshape_sum_backward(gy, x_shape, axis, keepdims):
    """Reshape gradient appropriately for shuzPy.functions.sum's backward.

    Args:
        gy (shuzPy.Variable): Gradient variable from the output by backprop.
    ...
    Returns:
        shuzPy.Variable: Gradient variable which is reshaped appropriately
    """
    ndim = len(x_shape)
    tupled_axis = axis
    if axis is None:
